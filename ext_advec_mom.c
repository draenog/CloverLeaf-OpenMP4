...
#pragma omp parallel for private(upwind, downwind,donor, dif, sigma, width, \
        limiter, vdiffuw, vdiffdw, auw, adw, wind, advec_vel_s)
        for (int k=y_min;k<=y_max+1;k++) 
        {
...
#pragma omp parallel for private(upwind, downwind, donor, dif, sigma, width, limiter, vdiffuw, vdiffdw, auw, adw, wind, advec_vel_s)
